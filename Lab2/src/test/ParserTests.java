...
//		runtest("module test { import jkfdshjkfdh; import haha; public int cw(int cw, cw cw1) {int cw2; }  public type cw3 = \"hello world\"; }");
...
//		runtest("module test {	public void runtest(string src) {   a[1] = 1;} }"); // refer to LhsExpression 
